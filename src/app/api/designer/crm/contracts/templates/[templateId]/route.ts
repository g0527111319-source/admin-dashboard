...
// PATCH /api/designer/crm/contracts/templates/[templateId]
export async function PATCH(
  ...
  try {
    ...
    const existing = await prisma.crmContractTemplate.findFirst({
...
// DELETE /api/designer/crm/contracts/templates/[templateId]
export async function DELETE(
  ...
  try {
    ...
    await prisma.crmContractTemplate.delete({ where: { id: templateId } });
