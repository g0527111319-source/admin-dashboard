            ...
            <div className="flex items-center gap-3">
              <div className="relative" style={{ width: 48, height: 48 }}>
                <div style={{
                  width: 48,
                  height: 48,
                  borderRadius: supplierData.supplierLogo ? 12 : '50%',
            ...
            <div className="space-y-3">
              {recentPosts.map((post) => (<div key={post.id} className="card-static" style={{ position: 'relative' }}>
                  <div style={{
                    ...
                    width: 28,
                    height: 28,
                    borderRadius: supplierData.supplierLogo ? 8 : '50%',
                        ...
                        <td className="font-medium">
                          <div className="flex items-center gap-2">
                            <div style={{
                              width: 24,
                              height: 24,
                              borderRadius: supplierData.supplierLogo ? 6 : '50%',
                              border: '2px solid #C9A84C',
                              overflow: 'hidden',
                              background: 'transparent',
                              display: 'flex',
                ...
                <div className="space-y-2 mb-3">
                  {recommenders.map((rec) => (<div key={rec.id} className="flex items-center justify-between p-3 bg-bg-surface rounded-btn group" style={{ position: 'relative' }}>
                      <div style={{
                        ...
                        width: 20,
                        height: 20,
                        borderRadius: supplierData.supplierLogo ? 5 : '50%',
                        overflow: 'hidden',
                        background: 'transparent',
                        display: 'flex',
                        alignItems: 'center',
