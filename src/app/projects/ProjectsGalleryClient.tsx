...
// Gallery + designer portfolio client. Extracted from the original
// src/app/projects/page.tsx so the page can be a server component that
// handles metadata + JSON-LD for SEO.
...
function ProjectsContent() {
  ...
  // UTM parameters — threaded into the public contact form so leads created
  // through designer share links are attributed back to the right campaign.
...
// =================================================================
// DesignerPortfolioView — full wireframe
// =================================================================
function DesignerPortfolioView({
  ...
  async function handleContactSubmit(e: React.FormEvent) {
    ...
    try {
      // Build UTM block only if at least one value is present — keeps
      // request bodies clean when users arrive organically.
      const utmBlock =
          ...
          >
            ...
            >
              {portfolioHeroImage ? (
                ...
                <div className="w-full h-full" style={{ background: "linear-gradient(160deg,#C9A84C,#8B6914)" }} />
              )}
              <div
                aria-hidden
